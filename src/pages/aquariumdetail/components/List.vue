<template>
    <div>
        ...
        <div class="recommend-title border-bottom">
               <span class="iconfont zan">&#xe600;</span> 超值特惠
        </div>
        ...
        <div class="recommend-title border-bottom">
               <span class="iconfont zan">&#xe600;</span> 提前预定，立享优惠
        </div>
...
export default {
    ...
    data (){
        return{
            ...
            todaylist:[{
                id:'001',
                title:'【限时活动夜场】大小同价特惠票（15点后入园）',
                deadline:'可订明日',
                money:'￥180'},
                {
                id:'002',
                title:'【即买即用】上海海昌海洋公园成人票',
                deadline:'可订明日',
                money:'￥355'},
                {
                id:'003',
                title:'上海海昌海洋公园全日学生票（仅限大学生）',
                deadline:'可订明日',
                money:'￥156'},
                
                ],
            notice:'2019年7月1日起，海象剧场新增人文演艺，表演时间为18:45，，海王电音表演时间调整为19：45。其他演艺时间将有对应调整，具体时间请关注运营预报。',
        }
    },
    methods:{
        handleReminderClick (){
