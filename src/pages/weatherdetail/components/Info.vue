   ...
   <div class="weatherinfo">
      <div class="icon">
          <div class="icon-wrapper">
                <img  class="icon-info" :src="this.iconList[this.$store.state.weatherList.img]" >
          </div>
      </div>
      <p class="temperature">{{this.$store.state.weatherList.temp}}<span>&#176;</span>
      </p>
      <p class="status">{{this.$store.state.weatherList.weather}}</p>
   </div>
</template>
<script>
export default {
