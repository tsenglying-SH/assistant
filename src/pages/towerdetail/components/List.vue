<template>
    <div>
        ...
        <div class="recommend-title border-bottom">
               <span class="iconfont zan">&#xe600;</span> 东方明珠看上海·超值票
        </div>
        ...
        <div class="recommend-title border-bottom">
               <span class="iconfont zan">&#xe600;</span> 东方明珠看上海·伴手礼票
        </div>
...
export default {
    ...
    data (){
        return{
            ...
            todaylist:[{
                id:'001',
                title:'【随买随用】东方明珠超值票-成人电子票-两球+多媒体+陈列馆',
                deadline:'21:20前随买随用',
                money:'￥195'},
                {
                id:'002',
                title:'东方明珠+空中玻璃栈道+历史陈列馆成人票',
                deadline:'可订明日',
                money:'￥175'},
                {
                id:'003',
                title:'东方明珠登塔参观+游船联票成人票',
                deadline:'可订明日',
                money:'￥185'},
                
                ],
            notice:'景区内实行全面禁烟！为了您和其他游客的健康，请不要在室内吸烟，敬请配合，多谢理解！',
        }
    },
    methods:{
        handleReminderClick (){
