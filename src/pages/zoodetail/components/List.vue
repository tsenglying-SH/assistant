<template>
    <div>
        ...
        <div class="recommend-title border-bottom">
               <span class="iconfont zan">&#xe600;</span> 门票
        </div>
        ...
        <div class="recommend-title border-bottom">
               <span class="iconfont zan">&#xe600;</span> 夜场票
        </div>
...
export default {
    ...
    data (){
        return{
            ...
            todaylist:[{
                id:'001',
                title:'【夜场早订早惠】上海野生动物园成人票',
                deadline:'17:00前随买随用',
                money:'￥55'},
                {
                id:'002',
                title:'【即买即用】上海野生动物园成人票（含猛兽区大巴游览）',
                deadline:'可订明日',
                money:'￥125'},
                {
                id:'003',
                title:'上海野生动物园双人套票（含普通马戏下午场）',
                deadline:'可订明日',
                money:'￥356'},
                
                ],
            notice:'即日起园内实行全面禁烟！为了您和其他游客及动物们的健康，请不要在园内吸烟，敬请配合，多谢理解！',
        }
    },
    methods:{
        handleReminderClick (){
