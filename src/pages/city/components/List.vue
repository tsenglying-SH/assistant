    ...
    <div class="list" ref="wrapper">
        ...
        <!-- <div class="area">
            ...
            <div class="item-list">
                ...
                <div class="item border-bottom">亳州</div>
                <div class="item border-bottom">保定</div>
                <div class="item border-bottom">宝山</div>
                <div class="item border-bottom">蚌埠</div>
                <div class="item border-bottom">百色</div>
                <div class="item border-bottom">蚌埠</div>
                <div class="item border-bottom">百色</div>
                <div class="item border-bottom">毕节</div>
                <div class="item border-bottom">滨州</div>
                <div class="item border-bottom">巴中</div>
            </div>
        </div>-->
